...
const plans = {
  ...
  other: {
    2: {
      title: "Nombrar qué necesitás ahora",
      ...
      steps: [
        ...
        "Elegí una necesidad: agua, calor, silencio, movimiento o pausa.",
        "Hacé solo esa cosa durante dos minutos.",
      ],
    },
    10: {
      ...
      steps: [
        "Releé lo que escribiste sobre este momento.",
        "Elegí una acción de diez minutos alineada a esa necesidad.",
        "Reducí un estímulo (pantalla, ruido o exigencia).",
        "Al terminar, marcá si cambió algo.",
      ],
    },
    30: {
      title: "Crear una pausa y observar qué responde",
      why: "Con más tiempo podés probar y comparar, que es lo que después alimenta tus patrones.",
      steps: [
        "Apartá treinta minutos sin otras tareas.",
        "Probá la acción que tiene más sentido para lo que escribiste.",
        "Anotá intensidad antes y después en una palabra.",
        "Guardá si vale repetirla la próxima vez.",
      ],
    },
  },
};
