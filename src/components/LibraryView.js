const principles = [
  ["Incertidumbre visible", "Feer diferencia una observación inicial, una conexión posible y un patrón repetido. No convierte pocos datos en certeza."],
  ...
  return `
    <section class="transparency-view" data-view-panel="library">
      <header class="editorial-header">
        ...
        <h2>Por qué Feer funciona así</h2>
